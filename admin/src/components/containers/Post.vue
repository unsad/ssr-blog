    ...
    <el-row :gutter="0">
      ...
      <el-col :span="6">
        <el-form-item label-width="20px">
          <el-button :class="{'margin-left': true}" type="info" @click.native="jump('prev')">
            <i class="el-icon-d-arrow-left"></i>
          </el-button>
          <el-button type="info" @click.native="jump('next')">
    ...
    watch: {
      'form.markdownContent': {
        ...
        handler: function(val, oldVal) {
          ...
          if (temp !== '' && val !== realVal && this.markdownChecked === false && historyTimestamp >= currentTimestamp) {
